...
class CalculatorApp:
    def __init__(self, root):
        ...
        self.style.configure('TButton', font=('Arial', 12), foreground='black', background='orange')
        ...
        for (text, row, col) in buttons:
            ttk.Button(root, text=text, command=lambda t=text: self.on_button_click(t)).grid(row=row, column=col, padx=5, pady=5)
